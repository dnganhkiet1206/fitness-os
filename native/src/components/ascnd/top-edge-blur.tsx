 ...
 * to a gradient of the backdrop's own top colour: not a blur, but the same
 * idea — content fades into the top edge rather than colliding with it. It is
 * the honest substitute, and it costs one `Rect`.
 */
        ...
        <Svg width="100%" height="100%" preserveAspectRatio="none">
          <Defs>
            <LinearGradient id="edgeFade" x1="0" y1="0" x2="0" y2="1">
              <Stop offset="0" stopColor={backdrop.colors[0]} stopOpacity={0.92} />
              <Stop offset="0.6" stopColor={backdrop.colors[0]} stopOpacity={0.45} />
              <Stop offset="1" stopColor={backdrop.colors[0]} stopOpacity={0} />
            </LinearGradient>
          </Defs>
...
const styles = StyleSheet.create({
  strip: {
    ...
    left: 0,
    right: 0,
    // Above the page, below the tab bar and any modal
    zIndex: 10,
  },
  fill: { flex: 1 },
});
