...
export function Mascot3D({
  ...
  // Keep the model's own (baked) face — a flat 2D overlay reads as a sticker and
  // detaches when the 3D head moves. Real face expression needs facial
  // blendshapes or texture animation on the mesh (tracked for later).
  return (
    <Canvas
