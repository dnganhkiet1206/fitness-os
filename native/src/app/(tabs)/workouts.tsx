 ...
 * recent-sessions block further down this same screen — which is what makes the
 * two read as one screen rather than two designs.
 *
  ...
  return (
    <Screen title={i18n.workoutsTitle}>
      ...
      {templates && templates.length > 0 ? (
        /* One card holding every saved workout, the way the sessions block
           below holds every logged one. A template created in the builder
           lands here as another row, not as another panel. */
