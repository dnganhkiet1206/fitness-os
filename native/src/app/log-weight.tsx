...
export default function LogWeightSheet() {
  ...
  */
  ...
  /* Cân thức dậy / giữ sáng / ngủ lại — cùng một hook với màn onboarding sắp
     tới, để hai chiếc cân không thể lệch nhịp. Xem `use-scale-wake.ts`: mọi
     chú thích về hai lớp, phép cộng độ mờ và ba mốc thời gian nằm ở đó.
