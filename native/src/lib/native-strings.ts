...
const en = {
  ...
  nCmWorkout: 'Workout',
  nCmMinutes: '~{n} min',
  nCmMoreExercises: '+ {n} more {n:exercise|exercises}',
  nCmTry: 'Try workout',
  ...
  nCmShare: 'Share',
  nCmMore: 'More',
  nCmShareText: '{title} on ASCND — {n} {n:exercise|exercises}',
  nCmJustNow: 'just now',
  nCmMinAgo: '{n}m ago',
  nCmHourAgo: '{n}h ago',
  nCmDayAgo: '{n}d ago',
  ...
  nPgTitle: 'Progress · {n} {n:week|weeks}',
  nPgFromTo: 'From {a} → {b}',
  nPgWeight: 'Weight',
  nPgWaist: 'Waist',
  ...
  nPvDeleted: 'Deleted {n} {n:post|posts}',
  ...
  nNtLikeMany: '{name} and {n} {n:other|others} liked your post',
  ...
  nRmLeft: 'Claim {c} {c:coin|coins} · {n} {n:day|days} left',
  nRmLast: 'Claim {c} {c:coin|coins} · today is the last day',
  nRmLeftPlain: '{n} {n:day|days} left to claim',
  nRmLastPlain: 'Today is the last day to claim',
  nNtUnread: 'unread',
  nShShare: 'Share',
  nShChallenge: '{title}: {a}/{b} {b:day|days}',
  ...
  nSrWhyActive: '{n} {n:post|posts} in the last 2 weeks',
  ...
  /* #43: tìm công thức theo tên món, cùng một ô tìm. */
  nSrOpen: 'Search people and recipes',
  nSrPeople: 'People',
  nSrRecipes: 'Recipes',
  nSrRecipeTitle: 'Find recipes',
  nSrRecipePlaceholder: 'Dish name',
  nSrRecipeIntro: 'Find a recipe by its dish name',
  nSrRecipeIntroHint: 'Accents are optional: "chicken bowl", "ga ap chao".',
  nSrRecipeNone: 'No recipe matches "{q}"',
  nSrRecipeNoneHint: 'Try one word from the dish name.',
  nUpAll: 'All',
  ...
  a11yRemove: 'Remove',
  a11yUndoLastDrink: 'Undo last drink',
  ...
  nWeightEntries: '{n} {n:entry|entries}',
  nWeightEntriesOne: '1 entry',
  nWeightSeeAll: 'See all {n} {n:entry|entries}',
  ...
  nSessionCount: '{n} {n:session|sessions} logged',
  nExerciseCount: '{n} {n:exercise|exercises}',
  nAboutMinutes: '~{n} min',
  nPlanNothingToday: 'Nothing planned today',
  nPlanAdded: 'Added to Plan · {d}',
  nRest: 'Rest',
  /* Trạng thái một ngày trong hàng tuần (#99) — chấm màu chỉ MẮT thấy, nhãn đọc nó cho VoiceOver. */
  nDayRest: 'rest day',
  nDayDone: 'trained',
  nDayTodo: 'planned',
  nDayMissed: 'missed',
  ...
  nRoutineExercises: '{n} {n:exercise|exercises}',
  ...
  nXiSessions: '{n} {n:session|sessions}',
  nXiE1rm: 'Est. 1RM',
  ...
  nXiWindowNote: 'Every number on this page reads the last {n} {n:day|days}.',
  nXiTapMore: 'Details',
  ...
  nXiLastDays: 'Last trained {n} {n:day|days} ago',
  nXiAgoShort: '{n}d ago',
  ...
  nXiWindowReps: 'Best in 90 days: {v} {v:rep|reps} at {w} {unit}, up from {prev}',
  nXiWindowRepsBody: 'Best in 90 days: {v} {v:rep|reps}, up from {prev}',
  nXiWindowAgo: '{n} {n:day|days} ago',
  nXiNeedMore: 'Needs {n} {n:session|sessions} before this can say anything',
  ...
  */
  ...
  nMpPreviewSum: '{d} {d:day|days} · {m} {m:meal|meals} a day · {t} {t:meal|meals} in all',
  ...
  nRmToday: 'today',
  nRmDaysAgo: '{n} {n:day|days} ago',
  nRmFoods: '{n} {n:food|foods}',
  ...
  nWbSummary: '{n} {n:exercise|exercises} · {s} {s:set|sets} · about {m} min',
  ...
  nWaterEntries: '{n} {n:entry|entries}',
  ...
  nMealDeleteMsg: 'This removes all {n} {n:food|foods} logged under {meal} today.',
  nMealDeleteMsgDay: 'This removes all {n} {n:food|foods} logged under {meal} on this day.',
  ...
  nPrRepsLine: '{ex} — {value} {value:rep|reps} at {w} {unit}, was {prev}',
  nPrRepsBodyLine: '{ex} — {value} {value:rep|reps}, was {prev}',
  ...
  nRoomWelcome: 'Welcome gift: +{n} {n:coin|coins}!',
  // Rank ladder
  ...
  nRoomLevelsToRank: '{n} {n:level|levels} to {r}',
  // Today's energy
  ...
  nRcRecipe: 'Recipe',
  nRcGrams: '{n} g',
  nRcMoreIngredients: '+ {n} more {n:ingredient|ingredients}',
...
const vi: typeof en = {
  ...
  nSrOpen: 'Tìm người và công thức',
  nSrPeople: 'Người',
  nSrRecipes: 'Công thức',
  nSrRecipeTitle: 'Tìm công thức',
  nSrRecipePlaceholder: 'Tên món',
  nSrRecipeIntro: 'Tìm công thức theo tên món',
  nSrRecipeIntroHint: 'Gõ không dấu cũng được: "ga ap chao", "salad".',
  nSrRecipeNone: 'Không có công thức nào khớp "{q}"',
  nSrRecipeNoneHint: 'Thử gõ một từ trong tên món.',
  nUpAll: 'Tất cả',
  ...
  a11yUndoLastDrink: 'Bớt lần uống gần nhất',
  editLayout: 'Sửa',
