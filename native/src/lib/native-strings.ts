...
const vi: typeof en = {
  ...
  nDay: 'Ngày',
  nNoMealPlans: 'Chưa có thực đơn',
  nMpAddFood: 'Thêm món',
  nMpStepPlanHint: 'Tên bạn sẽ gọi thực đơn này khi quay lại',
  nMpStepSlotsHint: 'Mỗi ngày trong thực đơn có mấy bữa',
  ...
  nMpStepMeal: 'Bữa',
  nMpStepFood: 'Món',
  nMpStepDayHint: 'Món này thuộc ngày nào trong thực đơn',
  ...
  nMpNoFibre: 'Ghi từ thực đơn thì không có chất xơ — thực đơn không lưu số đó.',
  // Ăn lại bữa đã ăn
