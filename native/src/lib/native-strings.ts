...
const en = {
  ...
  nRdResting: 'Rest',
  nRdSkip: 'Skip',
  nRdPreview: 'Looking ahead — only today can be logged',
  nRdLogged: 'Logged today',
  nRdEmptyPlan: 'This day has no workout on it',
  nRdSaved: 'Workout logged',
  nRdBodyweight: 'Bodyweight',
  nRoutineFinish: 'I trained this',
  nRoutineOpen: 'Open session',
...
const vi: typeof en = {
  ...
  nRdResting: 'Nghỉ',
  nRdSkip: 'Bỏ qua',
  nRdPreview: 'Xem trước — chỉ ghi được buổi tập của hôm nay',
  nRdLogged: 'Đã ghi hôm nay',
  nRdEmptyPlan: 'Ngày này chưa có buổi tập nào',
  nRdSaved: 'Đã ghi buổi tập',
  nRdBodyweight: 'Không tạ',
  nRoutineFinish: 'Đã tập xong',
  nRoutineOpen: 'Xem buổi tập',
