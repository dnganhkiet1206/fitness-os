...
const vi: Translations = {
  ...
  */
  ...
  nutritionYourPlans: 'Thực đơn của bạn',
  nutritionCreateNew: 'Tạo mới',
  nutritionCreatePlan: 'Tạo thực đơn',
  nutritionPlanName: 'Tên thực đơn',
  nutritionMealsPerDay: 'Số bữa/ngày',
  nutritionMeals: 'bữa',
  nutritionCreating: 'Đang tạo...',
  nutritionCreateBtn: 'Tạo thực đơn',
  nutritionNoPlans: 'Chưa có thực đơn nào',
  nutritionShoppingEmpty: 'Tạo thực đơn trước để có danh sách đi chợ',
  nutritionShoppingDesc: 'Danh sách đi chợ được tạo tự động từ thực đơn của bạn',
  nutritionCreated: 'Đã tạo thực đơn!',
  ...
  grocerySubtitle: 'Danh sách mua sắm từ thực đơn & danh sách tùy chỉnh',
  ...
  groceryFromMealPlan: 'Từ thực đơn',
