...
`supabase/migrations/` đã có **54 file SQL** dựng sẵn toàn bộ schema (16 file
...
python3 supabase/tests/community/b_reverse.py       # phá từng lớp bảo vệ (mọi ca trong b_cases.py), đòi test đỏ đúng chỗ; báo cả "vạ lây"
