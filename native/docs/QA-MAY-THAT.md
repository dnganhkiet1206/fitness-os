...
Trang này tồn tại vì một lý do hẹp: **285 bước kiểm tự động và một bộ chạy web
...
## J. VoiceOver đọc trạng thái ô chọn, ô tick, và các nút từng không tên, không vai — #99 · #101 · #120 · #121 · #123 · #125 · #127 · #129 · #133 · #135 · #137 · #145 (#104)
...
| J19 | Có ít nhất một thực phẩm bổ sung: Dinh dưỡng → hàng "Thực phẩm bổ sung" (tiếng Việt, iPhone SE hoặc AX3); rồi Hôm nay → thẻ Thực phẩm bổ sung | Hàng đọc trọn "Thực phẩm bổ sung" — xuống dòng được, **không** "Thực phẩm bổ…" — và bên phải là "1/2 hôm nay". Trên thẻ ở Hôm nay, mỗi dòng là **ô tick**: VoiceOver đọc "\<tên\>, \<liều\>" kèm trạng thái đã đánh dấu hay chưa (#137) | ☐ |
| J20 | Tập luyện → lịch sử buổi tập (`/sessions`) → vuốt qua một hàng buổi tập bằng VoiceOver | Mỗi hàng chỉ có **một** nút "Xoá" (cái thùng rác nhìn thấy được); tấm nút vuốt phía sau hàng không được đọc (#145). Vuốt lên/xuống trên hàng cho các hành động vuốt như trước (#133) | ☐ |
| J21 | Dinh dưỡng, rồi Tập luyện, rồi Cộng đồng → cuộn xuống cho Koa khuất (mờ hẳn), rồi vuốt VoiceOver qua hết màn; cuộn ngừng cho Koa hiện lại và vuốt tiếp | Khi Koa khuất, VoiceOver **không** dừng ở một nút "Koa" nào — nút vô hình đã rời cây trợ năng, không chỉ thôi nhận chạm (#147). Khi Koa hiện lại, VoiceOver đọc được nó như trước. Hàng bữa đang vuốt ngang: tấm nút phía sau hàng không được đọc (#147) | ☐ |
