...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay
    ref={ref}
    className={cn("fixed inset-0 z-[110] bg-black/40 backdrop-blur-sm", className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-x-0 bottom-0 z-[110] mt-24 flex h-auto flex-col rounded-t-[20px] border-t border-x overflow-hidden",
        className,
      )}
      style={{
