...
export function AppSidebar() {
  return (
    <Sidebar className="border-r border-border/40 bg-card/40 backdrop-blur-xl">
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground/60 px-4">Main</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {mainItems.map((item) => (
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground/60 px-4">Analytics</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
